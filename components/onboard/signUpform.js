...
const SignUp = () => {
  ...
  return (
    <div className="my-1 w-full">
      <form className="lg:py-20 ">
        <div className="flex flex-col md:h-full">
          <div className="grid md:grid-cols-2 grid-col-1 gap-2">
            <input
              className="p-2 m-2 pl-2 placeholder-gray-500 border-b-2 min-w-full min-h-full  tracking-wide focus:outline-none placeholder-opacity-75 text-sm lg:pt-10"
              placeholder="first Name*"
              value={firstName}
              onChange={handleOnChange("firstName")}
            />
            <input
              className="p-2 m-2 pl-2 placeholder-gray-500 border-b-2 min-w-full min-h-full border-1 tracking-wide  focus:outline-none placeholder-opacity-75 text-sm lg:pt-10"
